...
private:
    ...
    // for save path
    ros::Publisher m_path_save_pub; 
    ros::Subscriber m_path_save_sub;
    void savePathSub(const std_msgs::BoolPtr&);
    
    void publishMap(GMapping::ScanMatcher&);
    void publishPath();
    sensor_msgs::LaserScan scan_; // this scan used for publish map
